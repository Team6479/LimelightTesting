...
public class Robot extends TimedRobot {
  ...
  public Robot() {
    ...
    turret.setDefaultCommand(new TeleopTurretControl(
        turret,
        ()
  ...
  // final double DESIRED_TARGET_AREA = 13.0; // Area of the target when the
  // robot reaches the wall final double ACCELERATED_STEER_AREA = 17; final
  // double ACCELERATED_STEER_K = 0.02; final double MAX_DRIVE = 0.4; // Simple
